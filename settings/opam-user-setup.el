...
;; ## added by OPAM user-setup for emacs / tuareg ## 86edc7c9e724794177d5c991c7ad5ff6 ## you can edit, but keep this line
...
(when (not (member "tuareg" opam-tools-installed))
  (defun opam-tuareg-autoload (fct file doc args)
    (let ((load-path (cons "/Users/sekibomazic/.opam/4.02.3/share/emacs/site-lisp" load-path)))
      (load file))
    (apply fct args))
...
;; ## added by OPAM user-setup for emacs / ocp-indent ## 05215d488fdb4465eb45792cd9132d3d ## you can edit, but keep this line
;; Load ocp-indent from its original switch when not found in current switch
(when (not (assoc "ocp-indent" opam-tools-installed))
  (autoload 'ocp-setup-indent "/Users/sekibomazic/.opam/4.02.3/share/emacs/site-lisp/ocp-indent.el" "Improved indentation for Tuareg mode")
  (autoload 'ocp-indent-caml-mode-setup "/Users/sekibomazic/.opam/4.02.3/share/emacs/site-lisp/ocp-indent.el" "Improved indentation for Caml mode")
  (add-hook 'tuareg-mode-hook 'ocp-setup-indent t)
  (add-hook 'caml-mode-hook 'ocp-indent-caml-mode-setup  t)
  (setq ocp-indent-path "/Users/sekibomazic/.opam/4.02.3/bin/ocp-indent"))
